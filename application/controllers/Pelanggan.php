...
class Pelanggan extends CI_Controller
{
    ...
    function get($no)
    {
        ...
        redirect(base_url('pelanggan/edit/' . $no . '/'  . $url_slug));
    }
    ...
    function ubah()
    {
        ...
        $id_pel = $this->input->post('id_pel') != "" ? $this->input->post('id_pel') : NULL;
    ...
    public function hapus($no)
    {
        ...
        $data = $this->M_Pelanggan->get($no);
        if ($data) {
            $this->M_Pelanggan->hapus($no);

    ...
    public function pelanggan()
    {
        ...
        foreach ($index as $x) {
            $spreadsheet->setActiveSheetIndex(0)
                ...
                ->setCellValue('Q' . $kolom, $x['nama_instalatir'])
                ...
                ->setCellValue('AA' . $kolom, $x['alamat']);
            $kolom++;
            $nomor++;
        }

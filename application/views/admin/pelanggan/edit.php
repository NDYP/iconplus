            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input name="biaya_instalasi" value="<?= $pelanggan['biaya_instalasi']; ?>" type="text"
                            class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input name="paket_tambahan" value="<?= $pelanggan['paket_tambahan']; ?>" type="text"
                            class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                    </div>
                    <div class="form-group">
                        ...
                        <select name="jenis_kabel_dropcore" class="form-control select2" style="width: 100%;">
                            ...
                            <option value="UPC-UPC"
                                <?php if ($pelanggan['jenis_kabel_dropcore'] === 'UPC-UPC') echo 'selected="selected"'; ?>
                                <?= set_select('jenis_kabel_dropcore', 'UPC-UPC'); ?> name="jenis_kabel_dropcore">
                                UPC-UPC
                            </option>
                            <option value="APC-APC"
                                <?php if ($pelanggan['jenis_kabel_dropcore'] === 'APC-APC') echo 'selected="selected"'; ?>
                                <?= set_select('jenis_kabel_dropcore', 'APC-APC'); ?> name="jenis_kabel_dropcore">
                                APC-APC
                            </option>
                            <option value="APC-UPC(Hybrid)"
                                <?php if ($pelanggan['jenis_kabel_dropcore'] === 'APC-UPC(Hybrid)') echo 'selected="selected"'; ?>

<section class="content">
    ...
    <div class="row">
        ...
        window.onload = function() {
            ...
            //     })
            // }).bindTooltip('<?= json_encode($x['id_fat']); ?>').bindPopup(
            //     'ID FAT: <?= json_encode($x['id_fat']); ?> <br> Kapasitas Port Max: <?= $x['kapasitas_port_terpasang'] ?> <br> Kapasitas Port Terpasang: <?= $x['kapasitas_port_max'] ?>  <br> Koordinat: <?= $x['long'] . ' ' . $x['lat'] ?> <br> <br> <a class="btn btn-xs bg-green" href="<?= base_url('fat/edit/' . $x['no']); ?>" target="_blank"> <span class="fa fa-edit"></span> Ubah Data</a>'
            // );
            // <?php endforeach; ?>
            ...
            //     'ID FAT: <?= $x['id_fat'] ?> <br> Kapasitas Port Max: <?= $x['kapasitas_port_terpasang'] ?> <br> Kapasitas Port Terpasang: <?= $x['kapasitas_port_max'] ?>  <br> Koordinat: <?= $x['long'] . ' ' . $x['lat'] ?> <a class="btn btn-xs bg-green" href="<?= base_url('fat/edit/' . $x['no']); ?>" target="_blank"> <span class="fa fa-edit"></span> Ubah Data</a>'
            // );
            // <?php endforeach; ?>
            ...
            //     })
            // }).bindPopup(
            //     'ID POLE: <?= $pole['id'] ?> <br> <a class="btn btn-xs bg-green" href="<?= base_url('pole/edit/' . $pole['no']); ?>"" target="_blank"> <span class="fa fa-edit"></span> Ubah Data</a>'
            // );
            // <?php endforeach; ?>
            ...
            //     })
            // }).bindPopup(
            //     'No.SPA: <?= json_encode($a['no_spa']); ?> <br> SID: <?= json_encode($a['sid']); ?> <br> NIK: <?= json_encode($a['nik']); ?> <br> Nama Pelanggan: <?= json_encode($a['nama']); ?> <br> Nomor HP: <?= json_encode($a['no_hp']) ?> <br> Email : <?= json_encode($a['email']) ?> <br> Service ID: <?= json_encode($a['sid']) ?> <br> Lat: <?= $a['lat'] ?> <br> Long: <?= $a['long'] ?> <br> <br> <a class="btn btn-xs bg-green" href="<?= base_url('pelanggan/edit/' . $a['no']); ?>"" target="_blank"> <span class="fa fa-edit"></span> Ubah Data</a>'
            // );
            // <?php endforeach; ?>

        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <a class="btn btn-xs bg-green" href="<?= base_url('cluster/tambah') ?>"><span
                            class="fa fa-plus"></span> Add</a>
                    <a class="btn btn-xs bg-green" href="<?= base_url('excel/cluster') ?>"><span
                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm hidden-xs" style="width: 150px;">
                            <form method="POST" action="<?= base_url('cluster/search') ?>">
                            ...
                            <br>
                            <a class="btn btn-xs bg-yellow pull-right" href="<?= base_url('cluster/index') ?>"><span
                                ...
                                <table id="example3" class="table table-bordered table-striped dataTable nowrap"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                ...
                                                style="width: 66.1719px;">No.PA</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                colspan="1" aria-label="Platform(s): activate to sort column ascending"
                                                style="width: 80.7812px;">No.IO</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                colspan="1"
                                                aria-label="Engine version: activate to sort column ascending"
                                                style="width: 55.1094px;">Tanggal PPI</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                colspan="1" aria-label="CSS grade: activate to sort column ascending"
                                                style="width: 41.5781px;">Target PPI</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                colspan="1" aria-label="CSS grade: activate to sort column ascending"
                                                style="width: 41.5781px;">Instalatir</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                colspan="1" aria-label="CSS grade: activate to sort column ascending"
                                                style="width: 41.5781px;">File</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                colspan="1" aria-label="CSS grade: activate to sort column ascending"
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="sorting_1"><?= $x['nama_cluster'] ?></td>
                                            <td><?= $x['no_pa'] ?></td>
                                            <td><?= $x['no_io'] ?></td>
                                            <td><?= $x['ppi_date'] ?></td>
                                            <td><?= $x['target_ppi_date'] ?></td>
                                            <td><?= $x['nama_instalatir'] ?></td>
                                            <td class="sorting_1">
                                                <?php if ($x['file'] == NULL) : ?>
                                                -
                                                <?php else : ?>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li>
                                                            <a href="<?= base_url('berkas/tambah/' . $x['no']); ?>"
                                                                class="btn btn-social btn-flat btn-block btn-sm"><i
                                                                    class="fa fa-list-ol"></i>Upload Single Line</a>
                                                        </li>
                                                        <li>
                                                            <a href="<?= base_url('cluster/detail/' . $x['no']); ?>"
                                                                class="btn btn-social btn-flat btn-block btn-sm"><i
                                                                    class="fa fa-list-ol"></i>Detail</a>
                                                        </li>
                                                        <li>
                                                            <a href="<?= base_url('cluster/edit/' . $x['no']); ?>"
                                                                class="btn btn-social btn-flat btn-block btn-sm"><i
                                                                    class="fa fa-edit"></i>Ubah</a>
                                                        </li>
                                                        <li>
                                                            <a href="<?= base_url('cluster/hapus/' . $x['no']); ?>"
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
            <form name="myform" onsubmit="return val()" enctype="multipart/form-data" role="form"
                action="<?= base_url('cluster/tambah_excel') ?>" method="post">

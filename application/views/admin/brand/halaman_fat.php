<section class="content">
                ...
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm hidden-xs" style="width: 150px;">
                            ...
                            <br>
                            <br>
                            <a class="btn btn-xs bg-yellow pull-right" href="<?= base_url('master/fat') ?>"><span
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li>
                                                            <a href="<?= base_url('master/hapus_fat/' . $x['no']); ?>"
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
            <form name="myform" onsubmit="return val()" enctype="multipart/form-data" role="form"
                action="<?= base_url('master/tambah_fat') ?>" method="post">
    ...
    <div class="modal fade" id="modal-no<?= $z['no']; ?>">
        <div class="modal-dialog">
            <form name="myform" onsubmit="return val()" enctype="multipart/form-data" role="form"
                action="<?= base_url('master/ubah_fat'); ?>" method="post">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span></button>
